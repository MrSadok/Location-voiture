              ...
              <div className="container mx-auto px-4 text-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
                    ...
                    <div className="text-center p-4">
                        ...
                        <p className="text-sm text-gray-600">Competitive rates with no hidden fees guaranteed.</p>
                    </div>
                     ...
                     <div className="text-center p-4">
                        ...
                        <p className="text-sm text-gray-600">We are here to help anytime you need assistance.</p>
                    </div>
                     <div className="text-center p-4">
                         <div className="flex justify-center items-center mb-4 w-16 h-16 mx-auto bg-blue-100 text-blue-700 rounded-full">
                        ...
                        <h3 className="font-semibold text-lg mb-2 text-gray-800">New & Safe Fleet</h3>
                        <p className="text-sm text-gray-600">Wide range of modern, well-maintained, and safe cars.</p>
                    </div>
                </div>
              </div>
            </section>
